...
(
    ...
    name varchar(40),
    parentRaceId VARCHAR(40),
    FOREIGN KEY (parentRaceId) REFERENCES cms_races(raceId)
);

INSERT IGNORE INTO cms_races (raceId, name) VALUES ("00000000-0000-0000-0000-000000000003", "Kindred");
...
INSERT IGNORE INTO cms_skills (skillId, name, description, isSpSkill, IsTransformSkill, isRacialSkill, baseCostFighter, baseCostMage, baseCostTemplar, baseCostRogue, scaleCostFighter, scaleCostMage, scaleCostTemplar, scaleCostRogue)
...
INSERT IGNORE INTO cms_transforms (transformId, name) VALUES ("00000000-0000-0000-0000-000000000004", "Master Vampire");
...
INSERT IGNORE INTO cms_characters (characterId, playerId, dateCreated, name, title, activeStatus, raceId, subRace, skillPointsTotal, skillPointsSpend, class, strain, bodyMax, armorMax, transformId)
VALUES ("00000000-0000-0000-0000-00000000000Z", "00000000-0000-0000-0000-000000000001", NOW(), "Z", "Ambassador", "active", "00000000-0000-0000-0000-000000000003", "Spider", 700, 0, "Mage", 0, 10, 0, "00000000-0000-0000-0000-000000000004");
...
INSERT IGNORE INTO cms_mx_characters_skills (characterId, skillId, datePurchased, quantity, totalSkillPointCost) VALUES
("00000000-0000-0000-0000-00000000000Z", "00000000-0000-0000-0000-000000000005", NOW(), 3, 30);
...
INSERT IGNORE INTO cms_characters_manapoints (characterId, school, manaPoints) VALUES ("00000000-0000-0000-0000-00000000000Z", "Spirit", 100);
...
INSERT INTO cms_characters_plotEffects (characterId, dateCreated, effect) VALUES ("00000000-0000-0000-0000-00000000000Z", NOW(), "All transform skills unlocked");
