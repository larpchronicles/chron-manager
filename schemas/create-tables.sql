...
INSERT IGNORE INTO cms_characters (characterId, playerId, dateCreated, name, title, activeStatus, raceId, subRace,
                                   skillPointsTotal, skillPointsSpend, class, strain, bodyMax, armorMax, transformId)
